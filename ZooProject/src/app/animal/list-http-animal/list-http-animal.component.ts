...
@Component({
  selector: 'app-list-http-animal',
  templateUrl: './list-http-animal.component.html',
  styleUrls: ['./list-http-animal.component.css']
})
export class ListHttpAnimalComponent implements OnInit {
